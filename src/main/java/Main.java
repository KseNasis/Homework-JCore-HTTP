...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HttpGet raquest = new HttpGet(REMOTE_SERVICE_URI);
        raquest.setHeader(HttpHeaders.ACCEPT, ContentType.APPLICATION_JSON.getMimeType());

        CloseableHttpResponse response = httpClient.execute(raquest);
